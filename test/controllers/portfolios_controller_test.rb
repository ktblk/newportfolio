...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { githuburl: @portfolio.githuburl, herokuurl: @portfolio.herokuurl } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { githuburl: @portfolio.githuburl, herokuurl: @portfolio.herokuurl } }
